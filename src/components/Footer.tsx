...
export const Footer = () => (
    <footer id="contact" className="relative overflow-hidden border-t border-white/10 bg-black py-12">
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-6 md:flex-row">
            <div className="flex items-center gap-3"><BrandLogo className="h-8 w-8 text-gray-600"/>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">&copy; {new Date().getFullYear()} Liquid Development.
            All rights reserved.
        </div>
    </footer>
);
