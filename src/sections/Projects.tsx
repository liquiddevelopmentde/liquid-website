...
export const Projects = () => (
    <section id="projects" className="relative z-10 overflow-hidden bg-gradient-to-b from-[#0e0e0e] to-[#050505] py-32">
        <div
            className="pointer-events-none absolute right-0 top-1/4 h-1/2 w-1/2 rounded-full bg-[#00A3FF]/10 blur-[120px]"
        ></div>
        <div className="mx-auto max-w-7xl px-6">
            <div className="mb-20"><h2 className="mb-4 text-4xl font-bold md:text-5xl">Projects</h2>
                <div className="h-1 w-24 rounded-full bg-[#00A3FF]"></div>
            </div>
            <FadeInWhenVisible>
                <div
                    className="grid items-center gap-12 rounded-3xl border border-white/10 bg-[#121212] p-8 shadow-2xl transition-all duration-500 hover:border-[#00A3FF]/30 md:p-12 lg:grid-cols-2"
                >
                    <div>
                        <div
                            className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#00A3FF]/20 bg-[#00A3FF]/10 px-3 py-1 text-xs font-bold text-[#00A3FF]"
                        >
                        ...
                        >
                            ...
                            <ArrowRight
                                className="ml-2 transition-transform group-hover:translate-x-1" size={20}
                            />
                        </a>
                    </div>
                    <div
                        className="group relative flex h-[460px] items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-gray-900 to-black"
                    >
                        <div
                            className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"
                        ></div>
                        <div
                            className="relative flex h-[370px] w-[180px] transform flex-col overflow-hidden rounded-[2.5rem] border-[6px] border-gray-700 bg-gray-800 shadow-2xl transition-all duration-500 group-hover:rotate-[-2deg] group-hover:scale-105"
                        >
                            <div
                                className="absolute left-1/2 top-0 z-20 h-6 w-24 -translate-x-1/2 rounded-b-xl bg-black"
                            ></div>
                        ...
                        <div
                            className="absolute bottom-6 right-6 z-30 flex transform items-center gap-3 rounded-lg border border-[#00A3FF]/50 bg-black/80 p-3 shadow-lg backdrop-blur-md transition-transform group-hover:translate-y-2"
                        >
